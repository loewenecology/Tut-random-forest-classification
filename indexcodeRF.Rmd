...
One of the potential interactions identified by joint permutation was that of GALD and suspected toxin production. Given the potential functional and human health implications of toxin production, lets look at this relationship more closely.
...
Random forest are further applicable to regression problems, where splits can be performed to optimize mean square error of subgroups rather than classification success, as well as multivariate responses. Thus, random forests are a valuable asset to any ecologist's toolbox, especially for exploratory analysis of large data sets with many predictors and potential nonlinearities.
