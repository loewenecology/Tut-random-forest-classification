...
plot(get.tree.rfsrc(site.mod.forest, tree.id = 4000, class.type = "bayes"))
```
...
A top interaction identified by joint permutation was that of GALD and suspected toxin production. Given the potential functional and human health implications of toxin production, lets look at this relationship more closely.
