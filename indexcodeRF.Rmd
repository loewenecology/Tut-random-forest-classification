...
Here, we can see that error rates converged before we reach 10,000 trees, indicating that subsequent iterations were largely redundant.
...
However, the misclassification rate for the random forest constructed from these variables was 72% and the AUC was 0.59, indicating relatively poor predictive importance. Once again, error rates varied by class. Here, the best prediction was for module 06, which was correctly classified a little under half the time. 
...
Relatively poorer prediction accuracy was reflected by relatively greater fluctuation in cumulative error rates as additional trees were added to the forest. This was especially apparent in the cumulative error rates overall and for module 06, though both appear to have eventually converged.
...
Focusing in on module 06, we can see it has a somewhat noisy relationship with GALD, but is clearly structured by chlorophyll _b_ pigmentation, lack of phycobilins, ability to obtain nutrition from the consumption/adsorption of complex organic substrances (i.e. heterotrophy), and possibly a capacity for chain/colony formation.  
